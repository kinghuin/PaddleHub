...
#         length = len(e.text_a.split()) + len(e.text_b.split()) if e.text_b else len(e.text_a.split())
#         total_len += length
#         if length > max_len:
#             max_len = length
#         total_num += 1
#         if length > 128:
#             over_num += 1
#             overstr = ("\ntext_a: " + e.text_a + "\ntext_b:" + e.text_b) if e.text_b else e.text_a
#             overlen.append(overstr)
#     avg = total_len / total_num
#     for o in overlen[:2]:
#         print("The data length>128:{}".format(o))
#     print("The total number: {}\nThe avrage length: {}\nthe max length: {}\nthe number of data length > 128:  {}".format(total_num, avg, max_len, over_num))
